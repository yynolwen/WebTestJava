...
testControllers.controller('testCtrl', function ($scope, $http){
	$http.get("./php/question/ws/QuestionWs.php")
...
testControllers.controller('testCtrl', function ($scope) {
	...
	$scope.removeQuestion = function(test) {
		...
		//$scope.formData = {value : test.name };
...
testControllers.controller('formController', function($scope,$http, $location) {
		$scope.insertData=function (path) {
			$http.post("./php/question/ws/insert.php",{'nom':$scope.nom,'email':$scope.email,'phone':$scope.phone,'orga':$scope.orga})
...
/*
testControllers.controller('CountryListCtrl', function ($scope, countries){
  countries.list(function(countries) {
    $scope.countries = countries;
  });
});

testControllers.controller('CountryDetailCtrl', function ($scope, $routeParams, countries){
